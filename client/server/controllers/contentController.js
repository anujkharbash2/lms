...
exports.createLesson = async (req, res) => {
    const { course_id, title, content, sequence_order, category } = req.body;
    ...
    try {
        ...
        const [result] = await pool.query(
         'INSERT INTO Lessons (course_id, title, content, sequence_order, category) VALUES (?, ?, ?, ?, ?)',
         [course_id, title, content, sequence_order, category || 'Other']
         );
